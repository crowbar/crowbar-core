      ...
      class << self
        ...
        def cookbooks
          ...
          cookbooks_for_upload.each do |cookbook|
            ...
            return false unless check_links(cookbook)
            return false unless check_dependencies(cookbook)
          end
        ...
        def data_bags
          ...
          data_bags.each do |data_bag|
            ...
            data_bag_item_paths.each do |data_bag_item_path|
              ...
              logger.info("Uploading data_bag #{data_bag_item_path}")

              begin
                bag.save
              rescue Net::HTTPServerException => e
                logger.error("Uploading data_bag #{data_bag_item_path} failed (#{e.response.code})")
              end
            end
          end
          true
