...
Rails.application.routes.draw do
  ...
  get "crowbar/:controller/1.0/proposals/template", action: "proposal_template", as: "template_proposal_barclamp"
  post "crowbar/:controller/1.0/proposals/commit/:id", action: "proposal_commit", as: "commit_proposal_barclamp"
  get "crowbar/:controller/1.0/proposals/status(/:id)(/:name)", action: "proposal_status", as: "status_proposals_barclamp"
  ...
  post "crowbar/:controller/1.0/proposals/reset/:id", action: "proposal_reset", as: "reset_barclamp"
  ...
  get "crowbar/:barclamp/1.0/proposals/status", action: "proposal_status", controller: "barclamp"
  delete "crowbar/:barclamp/1.0/proposals/:id", action: "proposal_delete", controller: "barclamp"
  post "crowbar/:barclamp/1.0/proposals/reset/:id", action: "proposal_reset", controller: "barclamp"
