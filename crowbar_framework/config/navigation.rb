...
# UCS Plugin
    primary.item :ucs_servers, 'UCS', ucs_path do |secondary|
      secondary.item  :ucs_servers_dash, 'Dashboard', ucs_path 
      secondary.item :ucs_updateLogin, 'Settings', "/ucs?updateLogin=1"
    end
# End UCS Plugin
